...
## funny_countコマンド 
funny_countコマンドは、数字nを標準入力から受け取り、1~nまでの間にある3の倍数と3がつく数字を標準出力に表示するコマンドです。

## 謝辞
このコマンドはコメディアンである**世界のナベアツ(桂三度)**氏のネタ「3の倍数と3が付く数字の時だけアホになる」にインスパイアされて作成されました。
...
## 使い方
- 実行すると、1から入力された数字(今回は13)まで間にある3の倍数と3のついた数字が表示されます。
```
$ ./funny_count
13
3
